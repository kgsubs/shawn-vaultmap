    ...
    <div className="modal-backdrop" onClick={() => onClose(false)}>
      <div className="modal settings-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <p style={{marginBottom: 14}}>Your keys are never shared. They're only kept in this browser's <code>localStorage</code>. Delete any key and SAVE to remove from localStorage.</p>
